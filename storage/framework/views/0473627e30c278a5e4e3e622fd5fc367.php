        ...
        <div
            ...
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <h3 class="text-2xl font-black text-gray-900"><?php echo e($totalOrders); ?> <span
            ...
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <h3 class="text-2xl font-black text-gray-900"><span
                            class="text-sm">Rp</span><?php echo e(number_format($totalRevenue, 0, ',', '.')); ?></h3>
                </div>
            </div>
        </div>
        ...
        <div
            ...
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <h3 class="text-2xl font-black text-gray-900"><?php echo e($totalMenus); ?> <span
                ...
                <tbody class="divide-y divide-gray-100 text-sm">
                    <?php $__empty_1 = true; $__currentLoopData = $recentOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-orange-50/30 transition-colors group">
                            ...
                            <td class="px-6 py-4 font-semibold text-gray-700"><?php echo e($order->user->name); ?></td>
                            <td class="px-6 py-4 text-xs text-gray-500 font-medium">
                                <?php echo e($order->created_at->format('d M Y, H:i')); ?></td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\kedai-uqy\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>