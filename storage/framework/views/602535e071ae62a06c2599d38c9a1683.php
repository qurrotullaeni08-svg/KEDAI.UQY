...
<body class="antialiased bg-gray-50 text-gray-800 selection:bg-orange-500 selection:text-white" x-data="{ sidebarOpen: false }">
    ...
    <div class="flex h-screen overflow-hidden pt-20"> <!-- pt-20 offset for fixed navbar -->
        ...
        <?php if(auth()->guard()->check()): ?>
            <?php if(request()->routeIs('dashboard', 'admin.*', 'profile.*', 'orders.*')): ?>
                ...
                <header class="bg-white border-b border-gray-100 shadow-sm px-6 py-4 flex justify-between items-center sticky top-0 z-20">
                    <div class="flex items-center gap-4">
                        <?php if(auth()->guard()->check()): ?>
                            ...
                            <?php endif; ?>
                        <?php endif; ?>
                        <div class="text-xl font-bold text-gray-800"><?php echo e($header); ?></div>
                    </div>
                </header>
            <?php endif; ?>
                    ...
                    <?php if(session('error')): ?>
                        <div class="mb-6 bg-red-50 border-l-4 border-red-500 p-4 rounded-xl shadow-sm flex items-start" x-data="{ show: true }" style="display: none;" x-show="show" x-transition>
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-red-700 mt-1"><?php echo e(session('error')); ?></p>
                            </div>
                    ...
                    <footer class="max-w-7xl mx-auto bg-[#1a1512] text-gray-300 pt-16 pb-10 w-full">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
                            ...
                            <div class="space-y-6">
                                <div class="flex items-start gap-3">
                                    <img src="<?php echo e(asset('images/kedai.uqy.jpeg')); ?>" alt="Logo Kedai Uqy" class="w-12 h-12 rounded-xl object-cover shadow-lg shadow-orange-500/20 border-2 border-orange-500/20">
                        ...
                        <div class="border-t border-white/10 pt-8 flex flex-col items-center justify-center gap-4 text-center">
                            <p class="text-gray-500 text-sm">
                                &copy; <?php echo e(date('Y')); ?> Kedai Uqy. All rights reserved.
                            </p>
        ...
        <div x-show="loginModalOpen" style="display: none;" x-transition.opacity class="fixed inset-0 bg-gray-950/80 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
            <div x-show="loginModalOpen" 
                ...
                <div class="flex flex-col gap-3">
                    <a href="<?php echo e(route('login')); ?>" class="w-full py-3.5 rounded-xl text-white bg-gradient-to-r from-orange-600 to-orange-500 hover:from-orange-700 hover:to-orange-600 font-bold transition-all shadow-lg hover:shadow-orange-500/40 hover:-translate-y-0.5">
                        Sudah Memiliki Akun
                    </a>
                    <a href="<?php echo e(route('register')); ?>" class="w-full py-3.5 rounded-xl text-orange-500 bg-white/5 border border-orange-500/30 hover:bg-orange-500/10 hover:border-orange-500 font-bold transition-all">
                        Daftar Sekarang
                    </a>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\kedai-uqy\resources\views/layouts/app.blade.php ENDPATH**/ ?>